...
export function ExplorerAnnotationList(props: {
  ...
  defaultOpen?: boolean;
  /** "Focus" and "Edit" also open the annotation's keyframe in the Object view when given. */
  onOpenKeyframe?: (annotation: AnnotationFeature) => void;
}) {
  const { workspace } = props;
